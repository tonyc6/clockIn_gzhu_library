...
class clockIn():
    ...
    def step3(self):
        ...
        # 将下面的值转换成json格式
        reserve1 = json.loads(self.reserve_lib_seat(cookie, tomorrow, '18:20:00', '22:10:00'))
        reserve2 = json.loads(self.reserve_lib_seat(cookie, tomorrow, '14:30:00', '18:00:00'))
